<template>
  <div class="container-sm">
    ...
    <div class="container">
      <div v-if="room !=null" class="card-container">
            ...
            <div style="padding: 0%;">
              ...
              >
                <div class="carousel-inner">
                  ...
                  >
                    <img :src="image" class="cursor-pointer d-block w-100 my-img2" alt="..." />
                    <button
              ...
              <div class="card-body card-body-1">
                ...
                <p class="card-text">Balcony: {{ room.feature.balcony ? 'Yes' : 'No' }}</p>
                <p class="card-text">Tv: {{ room.feature.tv ? 'Yes' : 'No' }}</p>
                  
                <p class="card-text">Rooms service: {{ room.feature.roomService ? 'Yes' : 'No' }}</p>
                  
                <p class="card-text">Air Conditioning: {{ room.feature.airConditioning ? 'Yes' : 'No' }}</p>
                  
                <p class="card-text">Heat: {{ room.feature.heat ? 'Yes' : 'No' }}</p>
                  
                <p class="card-text">Wifi: {{ room.feature.wifi ? 'Yes' : 'No' }}</p>
                <p class="card-text">Bathroom: {{ room.feature.bathroom ? 'Yes' : 'No' }}</p>
...
onMounted(async () => {
  ...
  console.log("Room:", room.value); // Log the value of hotels
});
