    ...
    <div class="col-12 col-lg-10 col-xl-8 mx-auto">
        ...
        <div class="my-4">
            <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="user-settings" role="tab" aria-controls="home" aria-selected="false">Profile</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" id="contact-tab" data-toggle="tab" href="user-settings-notifications" role="tab" aria-controls="contact" aria-selected="false">Notifications</a>
                </li>
            </ul>
            <form>
                    ...
                    <div class="col">
                        <div class="row align-items-center">
                            <div class="col-md-7">
                                ...
                                <p class="small mb-3"><span class="badge text-black">New York, USA</span></p>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-md-7">
